...
import wallpapersData from "../../data/blinds.json"
import Card from "../../ui/Card"
import AnimationContainer from "../../ui/AnimationContainer"
import { Filter, SortAsc, ChevronDown, X } from "lucide-react"

export default function BlindsPageComp() {
 ...
 const matchesCategory =
  ...
  <h1 className="text-2xl lg:text-3xl font-bold text-gray-900">Blinds</h1>
          ...
          <p className="text-sm text-gray-500 mt-1">
            {filteredWallpapers.length} Blind{filteredWallpapers.length !== 1 ? "s" : ""} found
          </p>
        </div>
      ...
      {filteredWallpapers.length === 0 ? (
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">No blinds found</h3>
